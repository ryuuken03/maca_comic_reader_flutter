...
class CollectionDownloadsTab extends StatelessWidget {
  const CollectionDownloadsTab({super.key});
                  ...
                  onPressed: () {
                    showDialog(
                      ...
                      builder: (ctx) => DeleteConfirmationDialog(
                        ...
                        content:
                            'Hapus seluruh chapter unduhan untuk "${firstChap.comicTitle}"?',
                        onConfirm: () =>
                            downloadProvider.deleteDownloadedChaptersByComic(
                                comicId),
                      ),
                    );
                  },
                      ...
                      onPressed: () {
                        showDialog(
                          ...
                          builder: (ctx) => DeleteConfirmationDialog(
                            ...
                            content:
                                'Hapus unduhan "${chap.chapterTitle}"?',
                            onConfirm: () => downloadProvider
                                .deleteDownloadedChapter(chap.chapterUrl),
                          ),
                        );
                      },
                    ),
